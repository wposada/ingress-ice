...
launch() {
  ...
  then
    ...
    if [ ! $LOOP ]
    then
      $PHANTOMJS --ignore-ssl-errors=true --ssl-protocol=any "$SCRIPT_HOME/ice/ice.js" $ARGS; cd $PATH_GITS/3874aad99ad5ce803a6e482e7c7dc241;git pull;cp $PATH_CONF/.iced_cookies $PATH_GITS/3874aad99ad5ce803a6e482e7c7dc241/;echo "fin cp .ice";git add .;git commit -m "migits";git push;exit;
    else
      while :; do
